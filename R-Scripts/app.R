...
library(DT)
source("R scripts/Table_1_Function.R")
source("R scripts/Table_2_Function.R")
source("R scripts/Local_Max_List_Function.R")
source("R scripts/Spline_List_Function.R")
...
sidebar <- dashboardSidebar(
    ...
    sidebarMenu(
        ...
        menuItem("Relative/Wavelength Intensity Plots",
                 tabName = "relativeDash"),
...
body <- dashboardBody(
    ...
    tabItems(
                ...
                fluidPage(
                    ...
                    tabBox(width = 10,
                           ...
                           tabPanel("More Features",
                                    ...
                                    img(src = "Peak and Local Peak Hist.PNG",
                                        height = 520,
                                        width = 900),
                                    hr(),
                                    ...
                                    img(src = "Example Row Number.png",
                                        height = 200,
                                        width = 350),
                                    ...
                                    img(src = "Absolute and Local Max Hist.PNG",
                                        height = 520,
                                        width = 900),
                                    hr(),
                                    ...
                                    p(strong("Note:"), "You need to have the plot controls shown for the change to take
                                      place."),
                                    img(src = "Numeric Input Number of Bins.PNG",
                                        width = 700),
                                    img(src = "Plot Controls.PNG",
                                        height = 450,
                                        width = 900),
                                    hr(),
                                    ...
                                    img(src = "Multiple Smooth Splines.png",
                                        height = 520,
                                        width = 950)
                           )
        ...
        # Dataset Heatmaps Page ----
        # Content for "Dataset Heatmaps"
        tabItem(tabName = "datasetDash",
                # Download button for Normalized Absolute Max Intensity Heat Map
                downloadBttn("downloadgraph", 
                             "Download Normal Max Intensity Plot", 
                             color = "primary", 
                             size = "sm"),
                checkboxInput("checkTitle", 
                              "Include Title In Download", 
                              value = FALSE),
                ...
                downloadBttn("downloadgraph1",
                             "Download Peak Wavelength Plot",
                             color = "primary",
                             size = "sm"),
                checkboxInput("checkTitle1",
                              "Include Title In Download",
                              value = FALSE),
        ...
        # Relative/Wavelength Intensity Plots Page ----
        # Content for Relative/Wavelength Intensity Plots
        tabItem(tabName = "relativeDash",
                fluidRow(
                    column(4,
                           # Make two numeric entries for two wavelength values
                ...
                fluidRow(
                    ...
                    column(12,
                           ...
                           downloadBttn("downloadgraph2",
                                        "Download Relative Intensity Plot",
                                        color = "primary",
                                        size = "sm"),
                    ...
                    fluidRow(
                        column(6,
                               ...
                               downloadBttn("downloadgraph3", 
                                            "Download Wavelength 1 Intensity Plot",
                                            color = "primary",
                                            size = "sm"),
                        ...
                        column(6,
                               ...
                               downloadBttn("downloadgraph4",
                                            "Download Wavelength 2 Intensity Plot",
                                            color = "primary",
                                            size = "sm"),
        ...
        tabItem(tabName = "datasethistograms",
                fluidRow(
                    column(3,
                           ...
                           numericInput("numberOfBins",
                                        "Numeric Input: Number of Bins (Blue Histograms)",
                                        value = 2,
                                        min = 1),
                    ),
                    column(1,
                    ...
                    column(3,
                           ...
                           numericInput("numberOfBins1", 
                                        "Numeric Input: Number of Bins (Green Histograms)",
                                        value = 2,
                                        min = 1),
                    ),
                    column(1,
                ...
                conditionalPanel(condition = "input.showPltControl == '1'",
                                 ...
                                 fluidRow(
                                     ...
                                     column(3,
                                            ...
                                            actionBttn('applyChange',
                                                       "Apply Title/Axis Settings",
                                                       color = "primary")
                                     )
                                 ),
                ...
                conditionalPanel(condition = "input.showPltControl1 == '1'",
                                 ...
                                 fluidRow(
                                     column(3,
                                            ...
                                            textInput("textInp3",
                                                      "Histogram Title",
                                                      "Absolute/Local Max Values Histogram")
                                     ),
                                     column(3,
                                            # Text input: Horizontal Axis Title
                                            textInput("textInp4",
        ...
        tabItem(tabName = "smoothSpline",
                ...
                fluidRow(
                    column(4,
                           # Make numeric entry for row number to view smoothing
                           # spline interpolation graph with scatterplot
                           h4("Smooth Spline Interpolation Display Input",
                              align = "left"),
                           numericInput("rowIndex",
                                        "Enter row number",
                                        value = NULL,
                                        min = 0),
...
server <- function(input, output, session) {
    ...
    first_df <- reactive({
        ...
        dataset_mat <- as.matrix(df)  # Convert to matrix
        dataset_mat  # Output matrix
    })
    
    # Decompose Dataset ----
    # Subset wavelengths
    dataset_wavelengths <- eventReactive(input$file$datapath, {
        # Wavelengths are in the first row of first_df
        # First two entries are empty
        wavelengths_vec <- first_df()[1, - (1:2)]
        
        # Remove names associated with 
        wavelengths_vec <- unlist(wavelengths_vec, use.names = FALSE)
        
        wavelengths_vec  # Output vector
    })
    
    # Subset coordinates
    dataset_coordinates <- eventReactive(input$file$datapath, {
        # Coordinates are in the first two columns of first_df except the first
        # row
        first_df()[-1, 1:2]
    })
    ...
    dataset_intensities <- eventReactive(input$file$datapath, {
        # The intensities reside in everywhere else of first_df, or not in the
        # first row and not in the first two columns
        first_df()[-1,-(1:2)]
    })

    # Smoothing Spline Lists ---- 
    smoothing_spline_list <- eventReactive(input$file$datapath, {
        # Use get_spline_list function to obtain list of smoothing spline models
        get_spline_list(dataset_wavelengths(), dataset_intensities())
    })
    
    # Path 1 Normalization: Divide every row's intensities by the greatest
    # absolute max intensity value 
    normal_ss_list1 <- reactive({
        ss_list <- smoothing_spline_list()  # Assign spline list
        list_length <- length(ss_list)  # Find length of spline list
        
        # 4th column of dataset is the absolute max values
        absolute_max_intensity_vec <- unlist(dataset()[, 4], use.names = FALSE)
        
        # Find largest absolute max value
        dataset_max_intensity <- max(absolute_max_intensity_vec)
        
        # Create for loop
        for (k in 1:list_length) {
            # Normalize y values of smoothing spline model
            ss_list[[k]]$y <- ss_list[[k]]$y/dataset_max_intensity
        }
        ss_list  # Output normalized spline list 
    })
    
    # Path 2 Normalization: Divide each row's intensities by its respective
    # absolute max intensity value
    normal_ss_list2 <- reactive({
        ss_list <- smoothing_spline_list()  # Assign spline list
        list_length <- length(ss_list)  # Determine length of list
        ...
        for (k in 1:list_length) {
            # 
            ss_list[[k]]$y <- ss_list[[k]]$y/absolute_max_intensity_vec[k]
        }
        ss_list  # Output normalized spline list
    })
    ...
    selected_path_list <- reactive({
        # User selects Path 1
        if (input$pathChoice == "Global Max") {
            normal_ss_list1()  # Use normal_ss_list1
        # User selects Path 2    
        } else if (input$pathChoice == "Ind. Spectra Max") {
            normal_ss_list2()  # Use normal_ss_list2
        } else if (input$pathChoice == "None") {
            smoothing_spline_list()  # Use original smoothing spline list
        }
    })
    ...
    dataset <- eventReactive(input$file$datapath, {
        get_table_1(dataset_wavelengths(), dataset_coordinates(), smoothing_spline_list())
    })
    
    # Get Local Max List ----
    local_max_list <- eventReactive(input$file$datapath, {
        # Use get_local_max_list
        get_local_max_list(dataset_wavelengths(), smoothing_spline_list())
    })
    # Normal Intensity Heatmap ----
    ...
    output$downloadgraph <- downloadHandler(
        ...
        content = function(file) {
            ...
            # Show graph
            if(!input$checkTitle) {
                print(normMaxIntPlot())
            }
            else {
                print(normMaxIntPlot() + ggtitle("Normal Max Intensity Plot"))
            }
    ...
    normMaxIntPlot <- function() {
        ...
        df_absInt() %>%
        ggplot(aes(X, Y, fill= Normal_Intensity)) + 
            geom_tile() +
            theme_ipsum_es() +
            xlab("X") +
            ylab("Y") +
            labs(fill = "Normal Intensity") +
    ...
    # Output information for Normal Max Intensity heatmap
    output$info1 <- renderPrint({
        dataframe <- df_info12()[, -c(3,4)] %>% 
            nearPoints(input$click, threshold = 15, maxpoints = 1)
    ...
    # When user presses "Enter" after inputting limits
    observeEvent(input$applyLimits, {
        gradient_limits$lower_limit <- input$scaleLowerVal  # Assign lower value
        gradient_limits$upper_limit <- input$scaleUpperVal  # Assign upper value
    })
    
    # When user presses "Reset"
    observeEvent(input$reset, {
        # Assign original lower and upper values
        gradient_limits$lower_limit <- original_gradient_limits()[1]
        gradient_limits$upper_limit <- original_gradient_limits()[2]
    })
    
    # When user uploads new dataset
    ...
    # Find the original gradient limits for current dataset 
    original_gradient_limits <- reactive({
        # Round down the minimum wavelength value and round up the maximum 
        # wavelength value
        minimum <- floor(min(df_peakWave()$Wavelength))
        maximum <- ceiling(max(df_peakWave()$Wavelength))
        
        c(minimum, maximum)  # Output vector
    })
    
    peakWavePlot <- function() {
        # Convert gradient_limit list objects to vectors
        lower_gradient_limit <- unlist(gradient_limits$lower_limit,
                                       use.names = FALSE)
        upper_gradient_limit <- unlist(gradient_limits$upper_limit,
                                       use.names = FALSE)
        
        # Make ggplot2 static plot
        df_peakWave() %>%
        ggplot(aes(X, Y, fill = Wavelength)) +
            geom_tile() +
            theme_ipsum_es() +
            xlab("X") +
            ylab("Y") +
            labs(fill = "Wavelength") +
            scale_fill_gradient(low = "#800020",
                                high = "red",
                                limits = c(lower_gradient_limit,
                                           upper_gradient_limit),
    ...
    output$scaleLow <- renderUI({
        ...
        numericInput("scaleLowerVal",
                     "Enter Lower Limit Of Color Gradient",
                     value = default_value)
    })
    ...
    output$scaleUp <- renderUI({
        ...
        numericInput("scaleUpperVal",
                     "Enter Upper Limit Of Color Gradient",
                     value = default_value)
    })
    ...
    # Create table 2 using get_table_2
    bigger_data <- eventReactive(input$go, {
        if (is.na(input$wavelength1) || is.na(input$wavelength2)) {
            ...
            # Combine dataset() with dataframe created by get_table_2 (Relative Intensity Function.R) by column
            cbind(dataset(), get_table_2(input$wavelength1,input$wavelength2, smoothing_spline_list()))
        }
    })
    ...
    relIntPlot <- function() {
        ...
        # Make ggplot2 static plot
        p <- df_relInt() %>%
            ggplot(aes(X, Y, fill= Relative_Intensity)) + 
            geom_tile() +
            theme_ipsum_es() +
            xlab("X") +
            ylab("Y") +
            labs(fill = "Rel. Intensity") +
            scale_fill_gradient(low = "black", high = "red")
    ...
    output$info3 <- renderPrint({
        if (is.na(input$wavelength1) || is.na(input$wavelength2)) {
            return(print("Input wavelengths to generate plots."))
        }
        
        dataframe <- df_info345()[, -c(3,4,5)] %>%
            nearPoints(input$click1, threshold = 15, maxpoints = 1)
        number_of_rows <- nrow(dataframe)
    ...
    # Wavelength 1 Normal Intensity Heatmap ----
    ...
    wave1IntPlot <- function() {
        ...
        # Make ggplot2 static plot
        p <- df_wave1() %>%
            ggplot(aes(X, Y, fill= Normal_Wave_1_Intensity)) + 
            geom_tile() +
            theme_ipsum_es() +
            xlab("X") +
            ylab("Y") +
    ...
    output$info4 <- renderPrint({
        ...
        dataframe <- df_info345()[, -c(3:5,7:9)] %>%
            nearPoints(input$click2, threshold = 15, maxpoints = 1)
        number_of_rows <- nrow(dataframe)
    ...
    # Wavelength 2 Normal Intensity Heatmap ----
    ...
    wave2IntPlot <- function() {
        ...
        # Make ggplot2 static plot
        p <- df_wave2() %>%
            ggplot(aes(X, Y, fill= Normal_Wave_2_Intensity)) + 
            geom_tile() +
            theme_ipsum_es() +
            xlab("X") +
            ylab("Y") +
    ...
    output$info5 <- renderPrint({
        ...
        dataframe <- df_info345()[, -c(3:6,8:9)] %>%
            nearPoints(input$click3, threshold = 15, maxpoints = 1)
        number_of_rows <- nrow(dataframe)
    ...
    output$table <- renderDT({
        df_t1()
    }, escape = FALSE, rownames = FALSE, options = list(scrollX = TRUE))
    ...
    histogram_titles_and_values <- reactiveValues(lower_limit = NULL,
                                                  upper_limit = NULL,
                                                  increment = NULL, 
                                                  main_title = NULL,
                                                  xlabel = NULL,
    ...
    output$slider <- renderUI({
        ...
        sliderInput("inslider",
                    "Peak Wavelength (Blue)",
                    min = 1,
                    max = length(dataset()[,3]),
                    value = isolate(input$numberOfBins),
                    step = 1)
    })
    ...
    output$slider1 <- renderUI({
        ...
        sliderInput("inslider1",
                    "Local Peak Wavelength (Green)",
                    min = 1, 
                    max = length(unlist(local_max_list()[1:(length(local_max_list())/2)], use.names = FALSE)),
                    value = isolate(input$numberOfBins1),
                    step = 1)
    })
    ...
    output$downloadHist <- downloadHandler(
        ...
        content = function(file){
            ...
            peakLocWavePlot()
            title(main = histogram_titles_and_values$main_title,
                  xlab = histogram_titles_and_values$xlabel,
                  ylab = histogram_titles_and_values$ylabel)
            axis(1,
                 at = seq(histogram_titles_and_values$x_lower_limit,
                          histogram_titles_and_values$x_upper_limit,
                          by = histogram_titles_and_values$increment))
            dev.off()    
        }
    )
    ...
    output$classwidth <- renderText({
        # Display Class Width
        paste("Bin width is",
              (max(binsPeakWave()) - min(binsPeakWave())) / (length(binsPeakWave()) - 1), "nm")
    })
    ...
    peakLocWavePlot <- function() {
        ...
        if (input$peakcheck & input$localpeakcheck) {
            ...
            hist(dataset()[, 3],
                 ...
                 col = "blue",
                 border = "white",
                 xlim = c(histogram_titles_and_values$x_lower_limit, histogram_titles_and_values$x_upper_limit))
            hist(localPeakWave(),
                 breaks = binsLocWave(),
                 xaxt = "n",
                 col = rgb(0, 1, 0, 0.5),
    ...
    output$info6 <- renderPrint({
        ...
        peak_info <- c(lower_lim_peak,
                       higher_lim_peak,
                       z$mids[lower_lim_peak < z$mids & z$mids < higher_lim_peak],
                       peak_count)
        local_info <- c(lower_lim_local,
                        higher_lim_local,
                        y$mids[lower_lim_local < y$mids & y$mids < higher_lim_local],
                        local_count)
        ...
        if (input$peakcheck & input$localpeakcheck) {
            ...
            if(input$click4$x < min(c(binsPeakWave(),binsLocWave())) | input$click4$x > max(c(binsPeakWave(),binsLocWave()))) {
                ...
                colnames(df) <- c("Peak Wavelength",
                                  "Local Peak Wavelength")
                rownames(df) <- c("Lower Bin Limit",
                                  "Higher Bin Limit",
                                  "Midpoint",
                                  "Frequency")
                df
    ...
    # Absolute/Local Max Histogram ----
    # Reactive values for Absolute and Local Max Histogram
    histogram_titles_and_values1 <- reactiveValues(lower_limit = NULL,
                                                   upper_limit = NULL,
                                                   increment = NULL, 
                                                   main_title = NULL,
                                                   xlabel = NULL, 
    ...
    output$slider3 <- renderUI({
        ...
        # Lowest number is 1; highest number is how many elements are in each vector
        # Default value is 2
        sliderInput("inslider3",
                    "Local Max (Green)",
                    min = 1,
                    max = length(unlist(local_max_list()[(length(local_max_list())/2+1):length(local_max_list())], use.names = FALSE)),
                    value = isolate(input$numberOfBins1),
                    step = 1)
    })
    ...
    output$downloadHist1 <- downloadHandler(
        ...
        content = function(file) {
            ...
            absLocMaxPlot()
            title(main = histogram_titles_and_values1$main_title,
                  xlab = histogram_titles_and_values1$xlabel,
                  ylab = histogram_titles_and_values1$ylabel)
            axis(1,
                 at = seq(histogram_titles_and_values1$x_lower_limit,
                          histogram_titles_and_values1$x_upper_limit,
                          by = histogram_titles_and_values1$increment))
            dev.off()   
        }
    )
    ...
    absLocMaxPlot <- function() {
        ...
        if (input$absmaxcheck & input$localmaxcheck) {
            hist(dataset()[, 5],
                 ...
                 col = "blue",
                 border = "white",
                 xlim = c(histogram_titles_and_values1$x_lower_limit, histogram_titles_and_values1$x_upper_limit))
            hist(localMax(),
                 breaks = binsLocMax(),
                 xaxt = "n",
                 col = rgb(0, 1, 0, 0.5),
    ...
    output$info7 <- renderPrint({
        ...
        # Create vectors for each histogram consisting of lower and upper limits, midpoint, and frequency
        abs_info <- c(lower_lim_abs,
                      higher_lim_abs,
                      z$mids[lower_lim_abs < z$mids & z$mids < higher_lim_abs],
                      abs_count)
        local_info <- c(lower_lim_local,
                        higher_lim_local,
                        y$mids[lower_lim_local < y$mids & y$mids < higher_lim_local],
    ...
    # Dataset Smoothing Splines Plot ----
    # Value of row
    ...
    output$downloadDatasetSpectrum <- downloadHandler(
        # Create file name
        filename = function() {
            # SVG is selected
            if (input$select == 1) {
                # Name file
                paste0("Dataset Spectrum Plot", ".svg")
                
                # JPEG is selected
            } else if (input$select == 2) {
                # Name file
                paste0("Dataset Spectrum Plot", ".jpeg")
                
                # PNG is selected   
            } else if (input$select == 3) {
                # Name file
                paste0("Dataset Spectrum Plot", ".png")
            }
        },
        # Content for file
        content = function(file) {
    ...
    allSmooth <- function() {
        ...
        # Determine vertical axis range based on normalization method
        if (input$pathChoice != "None") {
            y_limits <- c(0, 1)
            ylabel <- "Normal Intensity"
        } else {
            y_limits <- c(0, max(dataset()[, 4]))
            ylabel <- "Intensity"
        }
        
        plot(dataset_wavelengths(),
             main = "Dataset Smooth Spline Lines",
             xlab = "Wavelength",
             ylab = ylabel,
             type = "n",
             xlim = c(min(dataset_wavelengths()), max(dataset_wavelengths())),
             ylim = y_limits)
    ...
    # Individual Smoothing Spline Plot ----
    # Window margins for zoomsmooth plot
    window_margins <- reactiveValues(x = NULL,
                                     y = NULL)
    ...
    output$downloadSpectrum <- downloadHandler(
        ...
        content = function(file) {
            ...
            if(input$pathChoice1 == "Global Max") {
                smoothSplPlot1()
            } else if (input$pathChoice1 == "Ind. Spectra Max") {
                smoothSplPlot2()
            } else if (input$pathChoice1 == "None") {
                smoothSplPlot3()
            }
    ...
    smoothSplPlot1 <- function() {
        ...
        plot(dataset_wavelengths(),
             y_values1(),
             xlab = "Wavelength",
             ylab = "Normal Intensity",
             main = paste("Normal Intensity vs. Wavelength \n X =", coordinates()[1],", Y = ", coordinates()[2]))
        
        # Plot smooth spline line, absolute max point, and local max points
        lines(splinesmoothfit1(), col = "red", lwd = 2)
        points(abs_max_coordinates1()[1],
               abs_max_coordinates1()[2],
               pch = 20,
               col = "blue",
               cex = 3)
        points(local_max_points1()[1, ],
               local_max_points1()[2, ],
               pch = 20,
               col = "green",
               cex = 3)
        legend("topright",
               c("Smoothing Spline","Absolute Max", "Local Max"),
               lwd = c(2, NA, NA),
    ...
    smoothSplPlot2 <- function() {
        ...
        points(abs_max_coordinates2()[1],
               abs_max_coordinates2()[2],
               pch = 20,
               col = "blue",
               cex = 3)
        points(local_max_points2()[1, ],
               local_max_points2()[2, ],
               pch = 20,
               col = "green",
               cex = 3)
    ...
    smoothSplPlot3 <- function() {
        # Plot points for given row on graph
        plot(dataset_wavelengths(),
             y_values3(),
             xlab = "Wavelength",
             ylab = "Intensity",
             main = paste("Intensity vs. Wavelength \n X =", coordinates()[1],", Y = ", coordinates()[2]))
        
        
        # Plot smooth spline line, absolute max point, and local max points
        lines(splinesmoothfit3(), col = "red", lwd = 2)
        points(abs_max_coordinates3()[1],
               abs_max_coordinates3()[2],
               pch = 20,
               col = "blue",
               cex = 3)
        points(local_max_points3()[1, ],
               local_max_points3()[2, ],
               pch = 20,
               col = "green",
               cex = 3)
    ...
    output$zoomsmooth <- renderPlot({
        ...
        if (input$pathChoice1 == "Global Max") {
            ...
            plot(dataset_wavelengths(),
                 ...
                 xlab = "Wavelength",
                 ylab = "Normal Intensity",
                 xlim = window_margins$x,
                 ylim = window_margins$y)
    ...
    output$info8 <- renderPrint({
        if (is.na(input$rowIndex)) {
            return(print("Enter a row number to generate plots."))
        }
        ...
        if (input$pathChoice1 == "Global Max") {
            ...
            dataframe <- brushedPoints(data.frame(Wavelength, Normal_Intensity),
                                       input$smoothPlot_brush,
                                       xvar = "Wavelength",
                                       yvar = "Normal_Intensity")
            ...
            # Determine x and y values of local max
            Wavelength <- local_max_points3()[1, ]
            Normal_Intensity <- local_max_points3()[2, ]
    ...
    # Reactive Values for Histograms ----
    
    # Create local peak wavelength vector
    localPeakWave <- reactive({
        unlist(local_max_list()[1:(length(local_max_list()) / 2)],
               use.names = FALSE)
    })
    
    # Calculate break points based on lowest & highest peak wavelength values
    # along with number of bins 
    binsPeakWave <- reactive({
        seq(min(dataset()[, 3]), max(dataset()[, 3]),
            length.out = input$inslider + 1)
    })
    
    # Calculate break points based on lowest & highest local peak wavelength
    # values along with number of bins
    binsLocWave <- reactive({
        seq(min(localPeakWave()), max(localPeakWave()),
            length.out = input$inslider1 + 1)
    })
    ...
    binsAbsMax <- reactive({
        seq(min(dataset()[, 5]), max(dataset()[, 5]),
            length.out = input$inslider2 + 1)
    })
    
    # Calculate break points
    binsLocMax <- reactive({
        seq(min(localMax()), max(localMax()),
            length.out = input$inslider3 + 1)
    })
    
    
    # Reactive values for Individual Spline Plot ----
    ...
    # Get raw intensities from dataset_intensities
    y_values3 <- eventReactive(input$go1, {
        dataset_intensities()[input$rowIndex, ]
    })
    ...
    # Smoothing spline without normalization
    splinesmoothfit3 <- eventReactive(input$go1, {
        smoothing_spline_list()[[input$rowIndex]]
    }) 
    ...
    # Get absolute max coordinates from "dataset"
    abs_max_coordinates3 <- eventReactive(input$go1, {
        c(dataset()[input$rowIndex, 3], dataset()[input$rowIndex, 4])
    })
    ...
    local_max_points1 <- eventReactive(input$go1, {
        ...
        # Create matrix by first unlisting p and then convert to a matrix where
        # the first row has wavelengths and second row has local max values
        local_max_matrix <- matrix(unlist(p, use.names = FALSE),
                                   nrow = 2,
                                   byrow = TRUE)
        absolute_max_intensity <- max(unlist(dataset()[, 4], use.names = FALSE))
    ...
    # Create local max matrix for "None" option
    local_max_points3 <- eventReactive(input$go1, {
        p <- local_max_list()[c(input$rowIndex, input$rowIndex + length(local_max_list()) / 2)]
    ...
    # Reactive values for heatmap plots/download buttons ----
    ...
    df_relInt <- reactive({
        ...
        colnames(test) <- c("X",
                            ...
                            "Intensity",
                            "Normal Intensity",
                            "Wavelength 1 Intensity",
                            "Wavelength 2 Intensity",
                            "Normal Wave 1 Intensity",
                            "Normal Wave 2 Intensity",
                            "Relative_Intensity")
        test
    })
    ...
    df_wave2 <- reactive({
        ...
        colnames(test) <- c("X",
                            ...
                            "Wavelength 2 Intensity",
                            "Normal Wave 1 Intensity",
                            "Normal_Wave_2_Intensity",
                            "Relative Intensity")
        test
    })

    
    # Reactive Values for Downloading Tables ----
    ...
    df_csv_t2 <- reactive({
        ...
        colnames(test) <- c(paste("Wavelength 1 Intensity",input$wavelength1),
                            paste("Wavelength 2 Intensity",input$wavelength2),
                            "Wavelength 1 Normal Intensity",
                            "Wavelength 2 Normal Intensity",
                            "Relative Intensity")
        test
    })
    ...
    df_info345 <- reactive({
        ...
        colnames(test) <- c("X",
                            ...
                            "Wavelength 1 Intensity",
                            "Wavelength 2 Intensity",
                            "Normal Wavelength 1 Intensity",
                            "Normal Wavelength 2 Intensity",
                            "Relative Intensity")
        test
    ...
    df_t1 <- reactive({
        test <- dataset()
        number_of_rows <- nrow(test)
        row_number_vector <- 1:number_of_rows
        test <- cbind(row_number_vector, test)
        colnames(test) <- c("Row Number",
                            "X", 
                            "Y",
    ...
    df_t2 <- reactive({
        ...
        test <- cbind(row_number_vector, test)
        colnames(test) <- c("Row Number",
                            paste(paste0("&lambda;", tags$sub(1)), "Intensity"), 
